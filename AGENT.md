...
1. **Spec first.** Before writing code for an exercise, write a short spec for it: what it must do, its inputs/outputs, and what "done" looks like (acceptance criteria). Save it as `SPEC.md` inside that exercise's folder.
